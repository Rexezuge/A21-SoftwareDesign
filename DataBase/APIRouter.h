...
class APIRouter {
 public:
  ...
  static void register_router(HttpService& router) {
    ...
    router.GET("/contacts/:groupName", [](HttpRequest* req,
                                          HttpResponse* resp) {
      // Parse the query URL
     ...
     * Create a new group.
     */
    router.POST("/groups/:groupName", [](HttpRequest* req, HttpResponse* resp) {
      std::string groupName = req->GetParam("groupName");
     ...
     */
    router.PATCH("/groups/:groupName/:contactName/:newGroupName",
                 [](HttpRequest* req, HttpResponse* resp) {
                   std::string groupName = req->GetParam("groupName");
                   std::string contactName = req->GetParam("contactName");
    ...
    router.POST("/tops/:group/:contact",
                [](HttpRequest* req, HttpResponse* resp) {
